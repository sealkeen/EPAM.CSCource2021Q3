...
namespace TextAndNumberDataConverter
{
    ...
    class WordLengthDetector {
        private double DetectAverage( string source )
        {
    ...
    //TODO: Create a class that implements a method that takes a string which contains text with phone numbers with format like(+X (XXX) XXX-XX-XX or X XXX XXX-XX-XX or +XXX (XX) XXX-XXXX).
